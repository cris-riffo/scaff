      ...
      (m = {
        init: function() {
          (a.animating = !1),
            ...
            a.vars.mousewheel &&
              a.on("mousewheel", function(e, t, n, i) {
                e.preventDefault();
            ...
            (!v || (v && a.vars.smoothHeight)) &&
              $(window).on("resize orientationchange focus", m.resize),
        ...
        controlNav: {
          ...
          setupPaging: function() {
            ...
            a.controlsContainer
              ...
              m.controlNav.set(),
              m.controlNav.active(),
              a.controlNavScaffold.on("a, img", r, function(e) {
        ...
        directionNav: {
          setup: function() {
            ...
            a.controlsContainer
              ...
              a.directionNav.on(r, function(e) {
                e.preventDefault();
                var t;
                ("" === o || o === e.type) &&
                  ((t = a.getTarget(
            ...
            u
              ...
              a.transitions
                ? ((a.vars.animationLoop && a.atEnd) ||
                  ...
                  a.container.off("webkitTransitionEnd transitionend"),
                  a.container.on(
